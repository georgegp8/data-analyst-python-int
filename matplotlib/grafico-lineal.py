# ================================================
# Ejercicios Matplotlib - Gráfico Lineal
# ================================================

# ------------------------------------------------
# Sección 1: Gráfico lineal (1)
# ------------------------------------------------
# Con matplotlib, puedes crear una gran cantidad de gráficos con diferentes métodos. Una de
# las más utilizadas es el gráfico lineal. Para hacer un gráfico lineal, debes llamar a la
# función plot(). Echa un vistazo a los arrays que se definen en el script: son las
# proyecciones de población mundial de las Naciones Unidas.

# Instrucciones:
# - print() la última cifra de la lista pop, que se refiere a las proyecciones de población
#   del año 2100.
# - Llama a plt.plot() con los años en el eje x y pop en el eje y.
# - Llama también a plt.show(), para que el gráfico se muestre correctamente.
...
# ------------------------------------------------
# Sección 2: Gráfico lineal (2): interpretación
# ------------------------------------------------
# Echa otro vistazo al gráfico que creaste en el ejercicio anterior; se muestra a la derecha.
# Según el gráfico, ¿en qué año aproximadamente habrá más de diez mil millones de seres
...
# ------------------------------------------------
# Sección 3: Gráfico lineal (3)
# ------------------------------------------------
# Tienes acceso a dos listas: life_exp que contiene la esperanza de vida de cada país para
# cada año disponible, y gdp_cap, que contiene el PIB per cápita (en dólares) de cada país.
# El PIB per cápita es un indicador de la riqueza de un país. Básicamente, es el dinero total
# que gana un país dividido entre el número de personas del país. Cuanto mayor sea este valor,
# más adinerado será el país.

# Instrucciones:
# - Imprime el último elemento de gdp_cap y life_exp.
# - Construye un gráfico lineal basado en life_exp en el eje y y gdp_cap en el eje x.
#   ¡No te olvides de plt.show()!
