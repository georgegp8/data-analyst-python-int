# ================================================
# Ejercicios Matplotlib - Gráfico de Dispersión
# ================================================

# ------------------------------------------------
# Sección 1: Diagrama de dispersión (1)
# ------------------------------------------------
# Cuando tienes una escala de tiempo a lo largo del eje horizontal, el gráfico de líneas es tu
# amigo. Pero, en muchos otros casos, como cuando intentas evaluar si existe una correlación
# entre dos variables, el diagrama de dispersión es la mejor opción. A continuación se muestra
# un ejemplo de cómo construir un gráfico de dispersión.
#
# import matplotlib.pyplot as plt
# plt.scatter(x, y)
# plt.show()
#
# Continuemos con el gráfico « gdp_cap » frente a « life_exp », los datos del PIB y la
# esperanza de vida de diferentes países en 2007. ¿Quizá un diagrama de dispersión sea una
# alternativa mejor?
# De nuevo, el paquete matplotlib.pyplot está disponible como plt.

# Instrucciones:
# - Cambia el gráfico de líneas que se ha programado en el script por un gráfico de dispersión.
# - La correlación se hace evidente cuando se muestra el PIB per cápita en una escala
#   logarítmica. Añade la línea plt.xscale('log').
...
# ------------------------------------------------
# Sección 2: Diagrama de dispersión (2)
# ------------------------------------------------
# En el ejercicio anterior, viste que un PIB más alto suele corresponder a una mayor esperanza
# de vida. En otras palabras, existe una correlación positiva.
# ¿Crees que existe una relación entre la población y la esperanza de vida de un país? Ya está
# disponible la lista life_exp del ejercicio anterior. Además, ahora también está disponible
# pop, con la lista de las poblaciones correspondientes a los países en 2007. Las poblaciones
# están en millones de personas.

# Instrucciones:
# - Empieza desde cero: importa matplotlib.pyplot como plt.
# - Construye un gráfico de dispersión, en el que pop aparezca en el eje horizontal y life_exp
#   en el vertical.
# - Termina el guión con plt.show() para visualizar el gráfico. ¿Ves una correlación?
...
# Build a scatter plot: pop on x-axis, life_exp on y-axis
