...
# ------------------------------------------------
# Sección 3: Construye un histograma (3): compara
# ------------------------------------------------
# life_exp contiene datos sobre la esperanza de vida en distintos países en 2007.
# También tienes acceso a life_exp1950, que contiene datos similares para 1950.
# ¿Puedes hacer un histograma para ambos conjuntos de datos?
# plt.show() y plt.clf() ya están incluidos para renderizarlo todo bien.

# Instrucciones:
# - Construye un histograma de life_exp con 15 barras.
# - Construye un histograma de life_exp1950, también con 15 barras.
#   ¿Hay una gran diferencia con el histograma de los datos de 2007?
...
# Histograma de life_exp con 15 barras
...
# Histograma de life_exp1950 con 15 barras
