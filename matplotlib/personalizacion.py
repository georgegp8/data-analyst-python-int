# ================================================
# Ejercicios Matplotlib - Personalización
# ================================================

# ------------------------------------------------
# Sección 1: Etiquetas
# ------------------------------------------------
# Es genial que hayas creado algunos gráficos, pero ¿puedes hacer también que los gráficos
# sean más informativos? Por ejemplo, añadiendo etiquetas de ejes.
# Para añadir las etiquetas de los ejes, puedes utilizar las funciones xlabel y ylabel.
# Siempre que quieras ir a una nueva línea puedes utilizar \n.
# Para añadir un título, utiliza la función title.

# Instrucciones:
# - El argumento xlabel ya está establecido en el código.
#   Establece el argumento ylabel en 'Life Expectancy [in years]'.
# - Utiliza title para añadir el título 'World Development in 2007' al gráfico.
# - Después de los comandos de personalización, finaliza con plt.show().

import matplotlib.pyplot as plt
import numpy as np

gdp_cap = [974.5803384, 5937.029525999999, 6223.367465, 4797.231267, 12779.37964,
           ...
           1327.60891, 27538.41188, 5186.050003, 942.6542111, 579.2317429999999,
           1201.637154, 3548.3308460000003, 39724.97867, 18008.94444, 36180.78919,
           2452.210407, 3540.651564, 11605.71449, 4471.061906, 40675.99635, 25523.2771,
           ...
           414.5073415, 12057.49928, 1044.770126, 759.3499101, 12451.6558, 1042.581557,
           ...
           15389.924680000002, 20509.64777, 19328.70901, 7670.122558, 10808.47561,
           863.0884639000001, 1598.435089, 21654.83194, 1712.472136, 9786.534714,
           862.5407561000001, 47143.17964, 18678.31435, 25768.25759, 926.1410683,
           9269.657808, 28821.0637, 3970.095407, 2602.394995, 4513.480643, 33859.74835,
           37506.41907, 4184.548089, 28718.27684, 1107.482182, 7458.396326999999,
           882.9699437999999, 18008.50924, 7092.923025, 8458.276384, 1056.380121,
           33203.26128, 42951.65309, 10611.46299, 11415.80569, 2441.576404, 3025.349798,
...
life_exp = [43.828, 76.423, 72.301, 42.731, 75.32, 81.235, 79.829, 75.635, 64.062, 79.441,
            ...
            59.443000000000005, 48.303, 74.241, 54.467, 64.164, 72.801, 76.195, 66.803,
            74.543, 71.164, 42.082, 62.069, 52.906000000000006, 63.785, 79.762, 80.204,
            72.899, 56.867, 46.859, 80.196, 75.64, 65.483, 75.53699999999999, 71.752,
            71.421, 71.688, 75.563, 78.098, 78.74600000000001, 76.442, 72.476, 46.242,
            65.528, 72.777, 63.062, 74.002, 42.568000000000005, 79.972, 74.663, 77.926,
            48.159, 49.339, 80.941, 72.396, 58.556, 39.613, 80.884, 81.70100000000001,
            74.143, 78.4, 52.517, 70.616, 58.42, 69.819, 73.923, 71.777, 51.542, 79.425,
